...
const Terms: NextPage = () => {
  return (
    <>
      <Head>
        <title>Bison Drywall | Terms</title>
      ...
      <main className="mx-auto max-w-4xl space-y-20 px-8 text-base lg:px-0">
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            parental permission to use the Site; (4) you will not access the
            Site through automated or non-human means, whether through a bot,
            script, or otherwise; (5) you will not use the Site for any illegal
            or unauthorized purpose; and (6) your use of the Site will not
        ...
        <section className="space-y-4">
          ...
          <ol className="ml-8 list-outside list-decimal space-y-1">
            ...
            <li>
              ou are the creator and owner of or have the necessary licenses,
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            <TertiaryPageLink
              ...
              label="https://bisondrywall.io/privacy"
            />
            ...
            in the United States. Further, we do not knowingly accept, request,
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            federal courts located in Winnebago, Wisconsin, and the Parties
        ...
        <section className="space-y-4 pb-20">
          ...
          <div>
            ...
            <p>United States</p>
            <p>Phone: (US)(920) 250-1319</p>
            <p>bisondrywallllc@gmail.com</p>
          </div>
        </section>
      </main>
    </>
